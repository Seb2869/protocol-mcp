...
export const ServerList = [
   ...
   * Production (Mainnet)
   */
  "https://{environment}.rarible.org",
] as const;

export const ServerEnvironment = {
  Api: "api",
  TestnetApi: "testnet-api",
} as const;
...
export function serverURLFromOptions(options: SDKOptions): URL | null {
  ...
  const serverParams: Params[] = [
    {
      "environment": options.environment ?? "api",
    },
  ];
  let params: Params = {};
...
export const SDK_METADATA = {
  language: "typescript",
  openapiDocVersion: "v0.1",
  sdkVersion: "0.0.1",
  genVersion: "2.616.1",
  userAgent: "speakeasy-sdk/typescript 0.0.1 2.616.1 v0.1 @rarible/protocol-mcp",
} as const;
